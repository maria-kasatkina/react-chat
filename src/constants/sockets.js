export const SOCKETS_CONNECTION_REQUEST = Symbol('sockets/SOCKET_CONNECTION_REQUEST');
export const SOCKETS_CONNECTION_SUCCESS = Symbol('sockets/SOCKET_CONNECTION_SUCCESS');
export const SOCKETS_CONNECTION_FAILURE = Symbol('sockets/SOCKET_CONNECTION_FAILURE');
